...
/**
 * @author S. Hourmann
 * Some improvements over the standard Agent.
 * Saving Bid History for the session.
 * 
		...
		do 
		{
			for(Issue lIssue:issues) 
			{
				...
				case INTEGER:
					...
					break;
				default: throw new Exception("issue type "+lIssue.getType()+" not supported by SamantaAgent2");
				}
			}
